...
store unique_places into 'twttr.places_hcat' using org.apache.hive.hcatalog.pig.HCatStorer();
...
store unique_users into 'twttr.users_hcat' using org.apache.hive.hcatalog.pig.HCatStorer();
